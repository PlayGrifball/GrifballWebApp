...
public interface IDiscordRestAuditLogEntry
{
    ...
    ulong GuildId { get; }
    System.DateTimeOffset CreatedAt { get; }
    bool TryGetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression, IDiscordAuditLogChange`1& change);
    IDiscordAuditLogChange<IDiscordTValue> GetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression);
    bool TryGetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression, JsonTypeInfo<IDiscordTValue> jsonTypeInfo, IDiscordAuditLogChange`1& change);
    IDiscordAuditLogChange<IDiscordTValue> GetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression, JsonTypeInfo<IDiscordTValue> jsonTypeInfo);
}
...
public interface IDiscordAuditLogChange
{
    ...
    IDiscordAuditLogChange<IDiscordTValue> WithValues(JsonTypeInfo<IDiscordTValue> jsonTypeInfo);
    IDiscordAuditLogChange<IDiscordTValue> WithValues();
}
...
public interface IDiscordTObject
{
     Original { get; }
    ulong Id { get; }
}
...
public interface IDiscordTValue
{
     Original { get; }
}


public interface IDiscordAuditLogChange<IDiscordTValue>
{
     Original { get; }
    IDiscordTValue NewValue { get; }
    IDiscordTValue OldValue { get; }
    string Key { get; }
    bool HasNewValue { get; }
    bool HasOldValue { get; }
    IDiscordAuditLogChange<IDiscordTValue> WithValues(JsonTypeInfo<IDiscordTValue> jsonTypeInfo);
...
public class DiscordGuild : IDiscordGuild
{
    ...
    public IDiscordImageUrl GetSplashUrl(NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetSplashUrl(format.Original));
    public IDiscordImageUrl GetDiscoverySplashUrl(NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetDiscoverySplashUrl(format.Original));
    ...
    public IAsyncEnumerable<IDiscordRestAuditLogEntry> GetAuditLogAsync(IDiscordGuildAuditLogPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetAuditLogAsync(paginationProperties.Original, properties.Original);
    ...
    public Task ModifyChannelPositionsAsync(IEnumerable<IDiscordGuildChannelPositionProperties> positions, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => _original.ModifyChannelPositionsAsync(positions, properties.Original, cancellationToken);
    ...
    public IAsyncEnumerable<IDiscordGuildUser> GetUsersAsync(IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetUsersAsync(paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordGuildBan> GetBansAsync(IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetBansAsync(paginationProperties.Original, properties.Original);
    ...
    public Task<NetCord.MfaLevel> ModifyMfaLevelAsync(NetCord.MfaLevel mfaLevel, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => _original.ModifyMfaLevelAsync(mfaLevel.Original, properties.Original, cancellationToken);
    ...
    public IAsyncEnumerable<IDiscordGuildScheduledEventUser> GetScheduledEventUsersAsync(ulong scheduledEventId, IDiscordOptionalGuildUsersPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetScheduledEventUsersAsync(scheduledEventId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordGuildUserInfo> SearchUsersAsync(IDiscordGuildUsersSearchPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.SearchUsersAsync(paginationProperties.Original, properties.Original);
...
public class DiscordTextChannel : IDiscordTextChannel
{
    ...
    public IAsyncEnumerable<IDiscordRestMessage> GetMessagesAsync(IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetMessagesAsync(paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordUser> GetMessageReactionsAsync(ulong messageId, IDiscordReactionEmojiProperties emoji, IDiscordMessageReactionsPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetMessageReactionsAsync(messageId, emoji.Original, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordUser> GetMessagePollAnswerVotersAsync(ulong messageId, int answerId, IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetMessagePollAnswerVotersAsync(messageId, answerId, paginationProperties.Original, properties.Original);
...
public class DiscordRestMessage : IDiscordRestMessage
{
    ...
    public IAsyncEnumerable<IDiscordUser> GetReactionsAsync(IDiscordReactionEmojiProperties emoji, IDiscordMessageReactionsPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetReactionsAsync(emoji.Original, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordUser> GetPollAnswerVotersAsync(int answerId, IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetPollAnswerVotersAsync(answerId, paginationProperties.Original, properties.Original);
...
public class DiscordMessageOptions : IDiscordMessageOptions
{
    ...
    public IDiscordMessageOptions WithEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordMessageOptions(_original.WithEmbeds(embeds));
    public IDiscordMessageOptions AddEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordMessageOptions(_original.AddEmbeds(embeds));
    ...
    public IDiscordMessageOptions WithComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordMessageOptions(_original.WithComponents(components));
    public IDiscordMessageOptions AddComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordMessageOptions(_original.AddComponents(components));
    ...
    public IDiscordMessageOptions WithAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordMessageOptions(_original.WithAttachments(attachments));
    public IDiscordMessageOptions AddAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordMessageOptions(_original.AddAttachments(attachments));
...
public class DiscordInteractionMessageProperties : IDiscordInteractionMessageProperties
{
    ...
    public IDiscordInteractionMessageProperties WithEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordInteractionMessageProperties(_original.WithEmbeds(embeds));
    public IDiscordInteractionMessageProperties AddEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordInteractionMessageProperties(_original.AddEmbeds(embeds));
    ...
    public IDiscordInteractionMessageProperties WithComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordInteractionMessageProperties(_original.WithComponents(components));
    public IDiscordInteractionMessageProperties AddComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordInteractionMessageProperties(_original.AddComponents(components));
    ...
    public IDiscordInteractionMessageProperties WithAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordInteractionMessageProperties(_original.WithAttachments(attachments));
    public IDiscordInteractionMessageProperties AddAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordInteractionMessageProperties(_original.AddAttachments(attachments));
...
public class DiscordGuildThread : IDiscordGuildThread
{
    ...
    public IAsyncEnumerable<IDiscordThreadUser> GetUsersAsync(IDiscordOptionalGuildUsersPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetUsersAsync(paginationProperties.Original, properties.Original);
    public Task ModifyPermissionsAsync(IDiscordPermissionOverwriteProperties permissionOverwrite, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => _original.ModifyPermissionsAsync(permissionOverwrite.Original, properties.Original, cancellationToken);
    public async Task<IEnumerable<IDiscordRestInvite>> GetInvitesAsync(IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => (await _original.GetInvitesAsync(properties.Original, cancellationToken)).Select(x => new DiscordRestInvite(x));
    public async Task<IDiscordRestInvite> CreateInviteAsync(IDiscordInviteProperties? inviteProperties = null, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => new DiscordRestInvite(await _original.CreateInviteAsync(inviteProperties.Original, properties.Original, cancellationToken));
    public Task DeletePermissionAsync(ulong overwriteId, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => _original.DeletePermissionAsync(overwriteId, properties.Original, cancellationToken);
    ...
    public IAsyncEnumerable<IDiscordGuildThread> GetPublicArchivedGuildThreadsAsync(IDiscordPaginationProperties<System.DateTimeOffset>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetPublicArchivedGuildThreadsAsync(paginationProperties.Original, properties.Original);
    public IAsyncEnumerable<IDiscordGuildThread> GetPrivateArchivedGuildThreadsAsync(IDiscordPaginationProperties<System.DateTimeOffset>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetPrivateArchivedGuildThreadsAsync(paginationProperties.Original, properties.Original);
    public IAsyncEnumerable<IDiscordGuildThread> GetJoinedPrivateArchivedGuildThreadsAsync(IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetJoinedPrivateArchivedGuildThreadsAsync(paginationProperties.Original, properties.Original);
...
public class DiscordGuildScheduledEvent : IDiscordGuildScheduledEvent
{
    ...
    public System.DateTimeOffset CreatedAt => _original.CreatedAt;
    public IDiscordImageUrl GetCoverImageUrl(NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetCoverImageUrl(format.Original));
    ...
    public Task DeleteAsync(IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => _original.DeleteAsync(properties.Original, cancellationToken);
    public IAsyncEnumerable<IDiscordGuildScheduledEventUser> GetUsersAsync(IDiscordOptionalGuildUsersPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetUsersAsync(paginationProperties.Original, properties.Original);
}
...
public class DiscordRole : IDiscordRole
{
    ...
    public ulong GuildId => _original.GuildId;
    public System.DateTimeOffset CreatedAt => _original.CreatedAt;
    public IDiscordImageUrl GetIconUrl(NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetIconUrl(format.Original));
...
public class DiscordGuildEmoji : IDiscordGuildEmoji
{
    ...
    public Task DeleteAsync(IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => _original.DeleteAsync(properties.Original, cancellationToken);
    public IDiscordImageUrl GetImageUrl(NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetImageUrl(format.Original));
}
...
public class DiscordRestAuditLogEntry : IDiscordRestAuditLogEntry
{
    ...
    public ulong GuildId => _original.GuildId;
    public System.DateTimeOffset CreatedAt => _original.CreatedAt;
    public bool TryGetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression, IDiscordAuditLogChange`1& change) => _original.TryGetChange(expression, change.Original);
    public IDiscordAuditLogChange<IDiscordTValue> GetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression) => new DiscordAuditLogChange`1(_original.GetChange(expression));
    public bool TryGetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression, JsonTypeInfo<IDiscordTValue> jsonTypeInfo, IDiscordAuditLogChange`1& change) => _original.TryGetChange(expression, jsonTypeInfo, change.Original);
    public IDiscordAuditLogChange<IDiscordTValue> GetChange(Expression<Func<IDiscordTObject, IDiscordTValue>> expression, JsonTypeInfo<IDiscordTValue> jsonTypeInfo) => new DiscordAuditLogChange`1(_original.GetChange(expression, jsonTypeInfo));
}
...
public class DiscordAutoModerationRuleProperties : IDiscordAutoModerationRuleProperties
{
    ...
    public IDiscordAutoModerationRuleProperties WithEventType(NetCord.AutoModerationRuleEventType eventType) => new DiscordAutoModerationRuleProperties(_original.WithEventType(eventType.Original));
    public IDiscordAutoModerationRuleProperties WithTriggerType(NetCord.AutoModerationRuleTriggerType triggerType) => new DiscordAutoModerationRuleProperties(_original.WithTriggerType(triggerType.Original));
    ...
    public IDiscordAutoModerationRuleProperties WithActions(IEnumerable<IDiscordAutoModerationActionProperties> actions) => new DiscordAutoModerationRuleProperties(_original.WithActions(actions));
    public IDiscordAutoModerationRuleProperties AddActions(IEnumerable<IDiscordAutoModerationActionProperties> actions) => new DiscordAutoModerationRuleProperties(_original.AddActions(actions));
...
public class DiscordAutoModerationRuleOptions : IDiscordAutoModerationRuleOptions
{
    ...
    public IDiscordAutoModerationRuleOptions WithActions(IEnumerable<IDiscordAutoModerationActionProperties> actions) => new DiscordAutoModerationRuleOptions(_original.WithActions(actions));
    public IDiscordAutoModerationRuleOptions AddActions(IEnumerable<IDiscordAutoModerationActionProperties> actions) => new DiscordAutoModerationRuleOptions(_original.AddActions(actions));
...
public class DiscordGuildEmojiProperties : IDiscordGuildEmojiProperties
{
    ...
    public IDiscordGuildEmojiProperties WithImage(NetCord.Rest.ImageProperties image) => new DiscordGuildEmojiProperties(_original.WithImage(image.Original));
...
public class DiscordGuildChannelProperties : IDiscordGuildChannelProperties
{
    ...
    public IDiscordGuildChannelProperties WithType(NetCord.ChannelType type) => new DiscordGuildChannelProperties(_original.WithType(type.Original));
    ...
    public IDiscordGuildChannelProperties WithPermissionOverwrites(IEnumerable<IDiscordPermissionOverwriteProperties> permissionOverwrites) => new DiscordGuildChannelProperties(_original.WithPermissionOverwrites(permissionOverwrites));
    public IDiscordGuildChannelProperties AddPermissionOverwrites(IEnumerable<IDiscordPermissionOverwriteProperties> permissionOverwrites) => new DiscordGuildChannelProperties(_original.AddPermissionOverwrites(permissionOverwrites));
    ...
    public IDiscordGuildChannelProperties WithAvailableTags(IEnumerable<IDiscordForumTagProperties> availableTags) => new DiscordGuildChannelProperties(_original.WithAvailableTags(availableTags));
    public IDiscordGuildChannelProperties AddAvailableTags(IEnumerable<IDiscordForumTagProperties> availableTags) => new DiscordGuildChannelProperties(_original.AddAvailableTags(availableTags));
...
public class DiscordGuildWelcomeScreenOptions : IDiscordGuildWelcomeScreenOptions
{
    ...
    public IDiscordGuildWelcomeScreenOptions WithWelcomeChannels(IEnumerable<IDiscordGuildWelcomeScreenChannelProperties> welcomeChannels) => new DiscordGuildWelcomeScreenOptions(_original.WithWelcomeChannels(welcomeChannels));
    public IDiscordGuildWelcomeScreenOptions AddWelcomeChannels(IEnumerable<IDiscordGuildWelcomeScreenChannelProperties> welcomeChannels) => new DiscordGuildWelcomeScreenOptions(_original.AddWelcomeChannels(welcomeChannels));
...
public class DiscordGuildOnboardingOptions : IDiscordGuildOnboardingOptions
{
    ...
    public bool? Enabled => _original.Enabled;
    public NetCord.Rest.GuildOnboardingMode? Mode => _original.Mode;
    public IDiscordGuildOnboardingOptions WithPrompts(IEnumerable<IDiscordGuildOnboardingPromptProperties> prompts) => new DiscordGuildOnboardingOptions(_original.WithPrompts(prompts));
    public IDiscordGuildOnboardingOptions AddPrompts(IEnumerable<IDiscordGuildOnboardingPromptProperties> prompts) => new DiscordGuildOnboardingOptions(_original.AddPrompts(prompts));
...
public class DiscordGuildScheduledEventProperties : IDiscordGuildScheduledEventProperties
{
    ...
    public IDiscordGuildScheduledEventProperties WithPrivacyLevel(NetCord.GuildScheduledEventPrivacyLevel privacyLevel) => new DiscordGuildScheduledEventProperties(_original.WithPrivacyLevel(privacyLevel.Original));
    ...
    public IDiscordGuildScheduledEventProperties WithEntityType(NetCord.GuildScheduledEventEntityType entityType) => new DiscordGuildScheduledEventProperties(_original.WithEntityType(entityType.Original));
...
public class DiscordApplicationCommandProperties : IDiscordApplicationCommandProperties
{
    ...
    public IDiscordApplicationCommandProperties AddIntegrationTypes(NetCord.ApplicationIntegrationType[] integrationTypes) => new DiscordApplicationCommandProperties(_original.AddIntegrationTypes(integrationTypes.Original));
    ...
    public IDiscordApplicationCommandProperties AddContexts(NetCord.InteractionContextType[] contexts) => new DiscordApplicationCommandProperties(_original.AddContexts(contexts.Original));
...
public class DiscordApplicationCommandOptions : IDiscordApplicationCommandOptions
{
    ...
    public IDiscordApplicationCommandOptions WithOptions(IEnumerable<IDiscordApplicationCommandOptionProperties> options) => new DiscordApplicationCommandOptions(_original.WithOptions(options));
    public IDiscordApplicationCommandOptions AddOptions(IEnumerable<IDiscordApplicationCommandOptionProperties> options) => new DiscordApplicationCommandOptions(_original.AddOptions(options));
    ...
    public IDiscordApplicationCommandOptions AddIntegrationTypes(NetCord.ApplicationIntegrationType[] integrationTypes) => new DiscordApplicationCommandOptions(_original.AddIntegrationTypes(integrationTypes.Original));
    ...
    public IDiscordApplicationCommandOptions AddContexts(NetCord.InteractionContextType[] contexts) => new DiscordApplicationCommandOptions(_original.AddContexts(contexts.Original));
...
public class DiscordApplicationCommandGuildPermissionProperties : IDiscordApplicationCommandGuildPermissionProperties
{
    ...
    public IDiscordApplicationCommandGuildPermissionProperties WithType(NetCord.ApplicationCommandGuildPermissionType type) => new DiscordApplicationCommandGuildPermissionProperties(_original.WithType(type.Original));
...
public class DiscordGuildStickerProperties : IDiscordGuildStickerProperties
{
    ...
    public IDiscordGuildStickerProperties WithFormat(NetCord.StickerFormat format) => new DiscordGuildStickerProperties(_original.WithFormat(format.Original));
...
public class DiscordGuildUsersSearchPaginationProperties : IDiscordGuildUsersSearchPaginationProperties
{
    ...
    public NetCord.Rest.PaginationDirection? Direction => _original.Direction;
    public int? BatchSize => _original.BatchSize;
    public IDiscordGuildUsersSearchPaginationProperties WithOrQuery(IEnumerable<IDiscordGuildUsersSearchQuery> orQuery) => new DiscordGuildUsersSearchPaginationProperties(_original.WithOrQuery(orQuery));
    public IDiscordGuildUsersSearchPaginationProperties AddOrQuery(IEnumerable<IDiscordGuildUsersSearchQuery> orQuery) => new DiscordGuildUsersSearchPaginationProperties(_original.AddOrQuery(orQuery));
    ...
    public IDiscordGuildUsersSearchPaginationProperties WithAndQuery(IEnumerable<IDiscordGuildUsersSearchQuery> andQuery) => new DiscordGuildUsersSearchPaginationProperties(_original.WithAndQuery(andQuery));
    public IDiscordGuildUsersSearchPaginationProperties AddAndQuery(IEnumerable<IDiscordGuildUsersSearchQuery> andQuery) => new DiscordGuildUsersSearchPaginationProperties(_original.AddAndQuery(andQuery));
...
public class DiscordMessageProperties : IDiscordMessageProperties
{
    ...
    public IDiscordMessageProperties WithAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordMessageProperties(_original.WithAttachments(attachments));
    public IDiscordMessageProperties AddAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordMessageProperties(_original.AddAttachments(attachments));
    ...
    public IDiscordMessageProperties WithEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordMessageProperties(_original.WithEmbeds(embeds));
    public IDiscordMessageProperties AddEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordMessageProperties(_original.AddEmbeds(embeds));
    ...
    public IDiscordMessageProperties WithComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordMessageProperties(_original.WithComponents(components));
    public IDiscordMessageProperties AddComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordMessageProperties(_original.AddComponents(components));
...
public class DiscordApplication : IDiscordApplication
{
    ...
    public System.DateTimeOffset CreatedAt => _original.CreatedAt;
    public IDiscordImageUrl GetIconUrl(NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetIconUrl(format.Original));
    public IDiscordImageUrl GetCoverUrl(NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetCoverUrl(format.Original));
    public IDiscordImageUrl GetAssetUrl(ulong assetId, NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetAssetUrl(assetId, format.Original));
    public IDiscordImageUrl GetAchievementIconUrl(ulong achievementId, string iconHash, NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetAchievementIconUrl(achievementId, iconHash, format.Original));
    public IDiscordImageUrl GetStorePageAssetUrl(ulong assetId, NetCord.ImageFormat format) => new DiscordImageUrl(_original.GetStorePageAssetUrl(assetId, format.Original));
...
public class DiscordReplyMessageProperties : IDiscordReplyMessageProperties
{
    ...
    public IDiscordReplyMessageProperties WithAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordReplyMessageProperties(_original.WithAttachments(attachments));
    public IDiscordReplyMessageProperties AddAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordReplyMessageProperties(_original.AddAttachments(attachments));
    ...
    public IDiscordReplyMessageProperties WithEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordReplyMessageProperties(_original.WithEmbeds(embeds));
    public IDiscordReplyMessageProperties AddEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordReplyMessageProperties(_original.AddEmbeds(embeds));
    ...
    public IDiscordReplyMessageProperties WithComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordReplyMessageProperties(_original.WithComponents(components));
    public IDiscordReplyMessageProperties AddComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordReplyMessageProperties(_original.AddComponents(components));
...
public class DiscordEmbedProperties : IDiscordEmbedProperties
{
    ...
    public IDiscordEmbedProperties WithColor(NetCord.Color color) => new DiscordEmbedProperties(_original.WithColor(color.Original));
    ...
    public IDiscordEmbedProperties WithFields(IEnumerable<IDiscordEmbedFieldProperties> fields) => new DiscordEmbedProperties(_original.WithFields(fields));
    public IDiscordEmbedProperties AddFields(IEnumerable<IDiscordEmbedFieldProperties> fields) => new DiscordEmbedProperties(_original.AddFields(fields));
...
public class DiscordMessagePollProperties : IDiscordMessagePollProperties
{
    ...
    public IDiscordMessagePollProperties WithAnswers(IEnumerable<IDiscordMessagePollAnswerProperties> answers) => new DiscordMessagePollProperties(_original.WithAnswers(answers));
    public IDiscordMessagePollProperties AddAnswers(IEnumerable<IDiscordMessagePollAnswerProperties> answers) => new DiscordMessagePollProperties(_original.AddAnswers(answers));
...
public class DiscordGuildChannelOptions : IDiscordGuildChannelOptions
{
    ...
    public IDiscordGuildChannelOptions WithPermissionOverwrites(IEnumerable<IDiscordPermissionOverwriteProperties> permissionOverwrites) => new DiscordGuildChannelOptions(_original.WithPermissionOverwrites(permissionOverwrites));
    public IDiscordGuildChannelOptions AddPermissionOverwrites(IEnumerable<IDiscordPermissionOverwriteProperties> permissionOverwrites) => new DiscordGuildChannelOptions(_original.AddPermissionOverwrites(permissionOverwrites));
    ...
    public IDiscordGuildChannelOptions WithAvailableTags(IEnumerable<IDiscordForumTagProperties> availableTags) => new DiscordGuildChannelOptions(_original.WithAvailableTags(availableTags));
    public IDiscordGuildChannelOptions AddAvailableTags(IEnumerable<IDiscordForumTagProperties> availableTags) => new DiscordGuildChannelOptions(_original.AddAvailableTags(availableTags));
...
public class DiscordPermissionOverwriteProperties : IDiscordPermissionOverwriteProperties
{
    ...
    public IDiscordPermissionOverwriteProperties WithType(NetCord.PermissionOverwriteType type) => new DiscordPermissionOverwriteProperties(_original.WithType(type.Original));
...
public class DiscordAuditLogChange : IDiscordAuditLogChange
{
    ...
    public IDiscordAuditLogChange<IDiscordTValue> WithValues(JsonTypeInfo<IDiscordTValue> jsonTypeInfo) => new DiscordAuditLogChange`1(_original.WithValues(jsonTypeInfo));
    public IDiscordAuditLogChange<IDiscordTValue> WithValues() => new DiscordAuditLogChange`1(_original.WithValues());
}
...
public class DiscordTObject : IDiscordTObject
{
    private readonly  _original;
    public DiscordTObject( original)
    {
        _original = original;
    }
...
public class DiscordTValue : IDiscordTValue
{
    private readonly  _original;
    public DiscordTValue( original)
    {
        _original = original;
    }
    public  Original => _original;
...
public class DiscordAuditLogChange<IDiscordTValue> : IDiscordAuditLogChange<IDiscordTValue>
{
    private readonly  _original;
    public DiscordAuditLogChange<IDiscordTValue>( original)
    {
        _original = original;
    }
    public  Original => _original;
    public IDiscordTValue NewValue => new DiscordTValue(_original.NewValue);
    public IDiscordTValue OldValue => new DiscordTValue(_original.OldValue);
    public string Key => _original.Key;
    public bool HasNewValue => _original.HasNewValue;
    public bool HasOldValue => _original.HasOldValue;
    public IDiscordAuditLogChange<IDiscordTValue> WithValues(JsonTypeInfo<IDiscordTValue> jsonTypeInfo) => new DiscordAuditLogChange`1(_original.WithValues(jsonTypeInfo));
...
public class DiscordAutoModerationRuleTriggerMetadataProperties : IDiscordAutoModerationRuleTriggerMetadataProperties
{
    ...
    public IDiscordAutoModerationRuleTriggerMetadataProperties AddPresets(NetCord.AutoModerationRuleKeywordPresetType[] presets) => new DiscordAutoModerationRuleTriggerMetadataProperties(_original.AddPresets(presets.Original));
...
public class DiscordAutoModerationActionProperties : IDiscordAutoModerationActionProperties
{
    ...
    public IDiscordAutoModerationActionProperties WithType(NetCord.AutoModerationActionType type) => new DiscordAutoModerationActionProperties(_original.WithType(type.Original));
...
public class DiscordGuildOnboardingPromptProperties : IDiscordGuildOnboardingPromptProperties
{
    ...
    public IDiscordGuildOnboardingPromptProperties WithType(NetCord.Rest.GuildOnboardingPromptType type) => new DiscordGuildOnboardingPromptProperties(_original.WithType(type.Original));
    public IDiscordGuildOnboardingPromptProperties WithOptions(IEnumerable<IDiscordGuildOnboardingPromptOptionProperties> options) => new DiscordGuildOnboardingPromptProperties(_original.WithOptions(options));
    public IDiscordGuildOnboardingPromptProperties AddOptions(IEnumerable<IDiscordGuildOnboardingPromptOptionProperties> options) => new DiscordGuildOnboardingPromptProperties(_original.AddOptions(options));
...
public class DiscordApplicationCommandOptionProperties : IDiscordApplicationCommandOptionProperties
{
    ...
    public int? MaxLength => _original.MaxLength;
    public bool? Autocomplete => _original.Autocomplete;
    public IDiscordApplicationCommandOptionProperties WithType(NetCord.ApplicationCommandOptionType type) => new DiscordApplicationCommandOptionProperties(_original.WithType(type.Original));
    ...
    public IDiscordApplicationCommandOptionProperties WithChoices(IEnumerable<IDiscordApplicationCommandOptionChoiceProperties> choices) => new DiscordApplicationCommandOptionProperties(_original.WithChoices(choices));
    public IDiscordApplicationCommandOptionProperties AddChoices(IEnumerable<IDiscordApplicationCommandOptionChoiceProperties> choices) => new DiscordApplicationCommandOptionProperties(_original.AddChoices(choices));
    ...
    public IDiscordApplicationCommandOptionProperties WithOptions(IEnumerable<IDiscordApplicationCommandOptionProperties> options) => new DiscordApplicationCommandOptionProperties(_original.WithOptions(options));
    public IDiscordApplicationCommandOptionProperties AddOptions(IEnumerable<IDiscordApplicationCommandOptionProperties> options) => new DiscordApplicationCommandOptionProperties(_original.AddOptions(options));
    ...
    public IDiscordApplicationCommandOptionProperties AddChannelTypes(NetCord.ChannelType[] channelTypes) => new DiscordApplicationCommandOptionProperties(_original.AddChannelTypes(channelTypes.Original));
...
public class DiscordMessageReferenceProperties : IDiscordMessageReferenceProperties
{
    ...
    public ulong MessageId => _original.MessageId;
    public bool FailIfNotExists => _original.FailIfNotExists;
    public IDiscordMessageReferenceProperties WithType(NetCord.MessageReferenceType type) => new DiscordMessageReferenceProperties(_original.WithType(type.Original));
...
public class DiscordApplicationEmojiProperties : IDiscordApplicationEmojiProperties
{
    ...
    public IDiscordApplicationEmojiProperties WithImage(NetCord.Rest.ImageProperties image) => new DiscordApplicationEmojiProperties(_original.WithImage(image.Original));
}
...
public class DiscordWebhookMessageProperties : IDiscordWebhookMessageProperties
{
    ...
    public IDiscordWebhookMessageProperties WithEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordWebhookMessageProperties(_original.WithEmbeds(embeds));
    public IDiscordWebhookMessageProperties AddEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordWebhookMessageProperties(_original.AddEmbeds(embeds));
    ...
    public IDiscordWebhookMessageProperties WithComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordWebhookMessageProperties(_original.WithComponents(components));
    public IDiscordWebhookMessageProperties AddComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordWebhookMessageProperties(_original.AddComponents(components));
    ...
    public IDiscordWebhookMessageProperties WithAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordWebhookMessageProperties(_original.WithAttachments(attachments));
    public IDiscordWebhookMessageProperties AddAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordWebhookMessageProperties(_original.AddAttachments(attachments));
...
public class DiscordApplicationCommandOptionChoiceProperties : IDiscordApplicationCommandOptionChoiceProperties
{
    ...
    public IDiscordApplicationCommandOptionChoiceProperties WithValueType(NetCord.Rest.ApplicationCommandOptionChoiceValueType valueType) => new DiscordApplicationCommandOptionChoiceProperties(_original.WithValueType(valueType.Original));
}
...
public class DiscordRestClient : IDiscordRestClient
{
    ...
    public async Task<IReadOnlyList<IDiscordApplicationRoleConnectionMetadata>> UpdateApplicationRoleConnectionMetadataRecordsAsync(ulong applicationId, IEnumerable<IDiscordApplicationRoleConnectionMetadataProperties> applicationRoleConnectionMetadataProperties, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => (await _original.UpdateApplicationRoleConnectionMetadataRecordsAsync(applicationId, applicationRoleConnectionMetadataProperties, properties.Original, cancellationToken)).Select(x => new DiscordApplicationRoleConnectionMetadata(x)).ToList();
    public IAsyncEnumerable<IDiscordRestAuditLogEntry> GetGuildAuditLogAsync(ulong guildId, IDiscordGuildAuditLogPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetGuildAuditLogAsync(guildId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordRestMessage> GetMessagesAsync(ulong channelId, IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetMessagesAsync(channelId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordUser> GetMessageReactionsAsync(ulong channelId, ulong messageId, IDiscordReactionEmojiProperties emoji, IDiscordMessageReactionsPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetMessageReactionsAsync(channelId, messageId, emoji.Original, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordThreadUser> GetGuildThreadUsersAsync(ulong threadId, IDiscordOptionalGuildUsersPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetGuildThreadUsersAsync(threadId, paginationProperties.Original, properties.Original);
    public IAsyncEnumerable<IDiscordGuildThread> GetPublicArchivedGuildThreadsAsync(ulong channelId, IDiscordPaginationProperties<System.DateTimeOffset>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetPublicArchivedGuildThreadsAsync(channelId, paginationProperties.Original, properties.Original);
    public IAsyncEnumerable<IDiscordGuildThread> GetPrivateArchivedGuildThreadsAsync(ulong channelId, IDiscordPaginationProperties<System.DateTimeOffset>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetPrivateArchivedGuildThreadsAsync(channelId, paginationProperties.Original, properties.Original);
    public IAsyncEnumerable<IDiscordGuildThread> GetJoinedPrivateArchivedGuildThreadsAsync(ulong channelId, IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetJoinedPrivateArchivedGuildThreadsAsync(channelId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordGuildUser> GetGuildUsersAsync(ulong guildId, IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetGuildUsersAsync(guildId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordGuildBan> GetGuildBansAsync(ulong guildId, IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetGuildBansAsync(guildId, paginationProperties.Original, properties.Original);
    ...
    public Task<NetCord.MfaLevel> ModifyGuildMfaLevelAsync(ulong guildId, NetCord.MfaLevel mfaLevel, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => _original.ModifyGuildMfaLevelAsync(guildId, mfaLevel.Original, properties.Original, cancellationToken);
    ...
    public IAsyncEnumerable<IDiscordGuildScheduledEventUser> GetGuildScheduledEventUsersAsync(ulong guildId, ulong scheduledEventId, IDiscordOptionalGuildUsersPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetGuildScheduledEventUsersAsync(guildId, scheduledEventId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordEntitlement> GetEntitlementsAsync(ulong applicationId, IDiscordEntitlementsPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetEntitlementsAsync(applicationId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordUser> GetMessagePollAnswerVotersAsync(ulong channelId, ulong messageId, int answerId, IDiscordPaginationProperties<ulong>? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetMessagePollAnswerVotersAsync(channelId, messageId, answerId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordSubscription> GetSkuSubscriptionsAsync(ulong skuId, IDiscordSubscriptionPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetSkuSubscriptionsAsync(skuId, paginationProperties.Original, properties.Original);
    ...
    public async Task<IReadOnlyList<IDiscordGoogleCloudPlatformStorageBucket>> CreateGoogleCloudPlatformStorageBucketsAsync(ulong channelId, IEnumerable<IDiscordGoogleCloudPlatformStorageBucketProperties> buckets, IDiscordRestRequestProperties? properties = null, System.Threading.CancellationToken cancellationToken = default) => (await _original.CreateGoogleCloudPlatformStorageBucketsAsync(channelId, buckets, properties.Original, cancellationToken)).Select(x => new DiscordGoogleCloudPlatformStorageBucket(x)).ToList();
    public IAsyncEnumerable<IDiscordGuildUserInfo> SearchGuildUsersAsync(ulong guildId, IDiscordGuildUsersSearchPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.SearchGuildUsersAsync(guildId, paginationProperties.Original, properties.Original);
    ...
    public IAsyncEnumerable<IDiscordRestGuild> GetCurrentUserGuildsAsync(IDiscordGuildsPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetCurrentUserGuildsAsync(paginationProperties.Original, properties.Original);
...
public class DiscordCurrentApplication : IDiscordCurrentApplication
{
    ...
    public IAsyncEnumerable<IDiscordEntitlement> GetEntitlementsAsync(IDiscordEntitlementsPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetEntitlementsAsync(paginationProperties.Original, properties.Original);
...
public class DiscordApplicationRoleConnectionMetadataProperties : IDiscordApplicationRoleConnectionMetadataProperties
{
    ...
    public string Description => _original.Description;
    public IReadOnlyDictionary<string, string> DescriptionLocalizations => _original.DescriptionLocalizations;
    public IDiscordApplicationRoleConnectionMetadataProperties WithType(NetCord.Rest.ApplicationRoleConnectionMetadataType type) => new DiscordApplicationRoleConnectionMetadataProperties(_original.WithType(type.Original));
...
public class DiscordGuildProperties : IDiscordGuildProperties
{
    ...
    public IDiscordGuildProperties WithRoles(IEnumerable<IDiscordRoleProperties> roles) => new DiscordGuildProperties(_original.WithRoles(roles));
    public IDiscordGuildProperties AddRoles(IEnumerable<IDiscordRoleProperties> roles) => new DiscordGuildProperties(_original.AddRoles(roles));
    ...
    public IDiscordGuildProperties WithChannels(IEnumerable<IDiscordGuildChannelProperties> channels) => new DiscordGuildProperties(_original.WithChannels(channels));
    public IDiscordGuildProperties AddChannels(IEnumerable<IDiscordGuildChannelProperties> channels) => new DiscordGuildProperties(_original.AddChannels(channels));
...
public class DiscordTestEntitlementProperties : IDiscordTestEntitlementProperties
{
    ...
    public IDiscordTestEntitlementProperties WithOwnerType(NetCord.Rest.TestEntitlementOwnerType ownerType) => new DiscordTestEntitlementProperties(_original.WithOwnerType(ownerType.Original));
}
...
public class DiscordSku : IDiscordSku
{
    ...
    public System.DateTimeOffset CreatedAt => _original.CreatedAt;
    public IAsyncEnumerable<IDiscordSubscription> GetSubscriptionsAsync(IDiscordSubscriptionPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetSubscriptionsAsync(paginationProperties.Original, properties.Original);
...
public class DiscordCurrentUser : IDiscordCurrentUser
{
    ...
    public IAsyncEnumerable<IDiscordRestGuild> GetGuildsAsync(IDiscordGuildsPaginationProperties? paginationProperties = null, IDiscordRestRequestProperties? properties = null) => _original.GetGuildsAsync(paginationProperties.Original, properties.Original);
...
public class DiscordForumGuildThreadMessageProperties : IDiscordForumGuildThreadMessageProperties
{
    ...
    public IDiscordForumGuildThreadMessageProperties WithEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordForumGuildThreadMessageProperties(_original.WithEmbeds(embeds));
    public IDiscordForumGuildThreadMessageProperties AddEmbeds(IEnumerable<IDiscordEmbedProperties> embeds) => new DiscordForumGuildThreadMessageProperties(_original.AddEmbeds(embeds));
    ...
    public IDiscordForumGuildThreadMessageProperties WithComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordForumGuildThreadMessageProperties(_original.WithComponents(components));
    public IDiscordForumGuildThreadMessageProperties AddComponents(IEnumerable<IDiscordComponentProperties> components) => new DiscordForumGuildThreadMessageProperties(_original.AddComponents(components));
    ...
    public IDiscordForumGuildThreadMessageProperties WithAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordForumGuildThreadMessageProperties(_original.WithAttachments(attachments));
    public IDiscordForumGuildThreadMessageProperties AddAttachments(IEnumerable<IDiscordAttachmentProperties> attachments) => new DiscordForumGuildThreadMessageProperties(_original.AddAttachments(attachments));
